...
class SSRP(Dataset):
    ...
    def __init__(self, root: str, pretrain: bool, download: bool = True, transform: Optional[Callable]=None, target_transform: Optional[Callable]=None):
        super().__init__()
        ...
        self._dataset = ImageFolder(path_to_data, transform=transform, target_transform=target_transform)
    ...
    def __getitem__(self, index: int) -> Union[Tuple[Tensor, Tensor, None], Tuple[Tensor, None, Tensor]]:
        if self.pretrain:
