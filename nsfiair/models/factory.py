...
def _block(args: InnArgs, input_dim: int, use_jit=False) -> layers.Bijector:
...
def _build_multi_scale_chain(
    args: InnArgs, input_dim, factor_splits, unsqueeze=False, use_jit=False
...
def build_conv_inn(args: InnArgs, input_shape: Tuple[int, ...], oxbow=False) -> layers.Bijector:
    input_dim = input_shape[0]
